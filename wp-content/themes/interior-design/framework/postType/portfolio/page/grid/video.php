...
<article id="post-<?php the_ID(); ?>" <?php post_class(); echo (($project_categs != '') ? ' data-category="' . esc_attr($project_categs) . '"' : '') ?>>
	...
	<?php 
		cmsmasters_thumb_rollover(get_the_ID(), $project_thumb_size, $rollover, true, true, false, $cmsms_project_video_type, $cmsms_project_video_link, $cmsms_project_video_links, $project_thumb_high, true, $cmsms_project_link_redirect, $cmsms_project_link_url);
