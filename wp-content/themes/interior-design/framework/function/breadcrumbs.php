...
function breadcrumbs() {
	...
	$homeText = esc_attr__('Home', 'interior-design');
	...
	if (is_single()) {
		...
		echo '<span>' . esc_html__('Search results for', 'interior-design') . ": '" . esc_html(get_search_query()) . "'</span>";
		...
		if (is_tax('post_format', 'post-format-gallery')) {
			echo '<span>' . _x('Galleries', 'post format archive title', 'interior-design') . '</span>';
		} elseif (is_tax('post_format', 'post-format-image')) {
			echo '<span>' . _x('Images', 'post format archive title', 'interior-design') . '</span>';
		} elseif (is_tax('post_format', 'post-format-video')) {
			echo '<span>' . _x('Videos', 'post format archive title', 'interior-design') . '</span>';
		} elseif (is_tax('post_format', 'post-format-audio')) {
			echo '<span>' . _x('Audio', 'post format archive title', 'interior-design') . '</span>';
		}
		...
		echo '<span>' . esc_html__('No breadcrumbs', 'interior-design') . '</span>';
	}
}
