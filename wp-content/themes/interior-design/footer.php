...
<!-- _________________________ Start Footer _________________________ -->
	<footer id="footer" role="contentinfo" class="<?php echo 'cmsms_color_scheme_' . $cmsms_option[CMSMS_SHORTNAME . '_footer_scheme'];
	?>">
		<div class="footer_bg">
			<div class="footer_inner">
		<?php

			if ($cmsms_option[CMSMS_SHORTNAME . '_footer_copyright'] !== '') {
				echo '<span class="copyright">' . stripslashes($cmsms_option[CMSMS_SHORTNAME . '_footer_copyright']) . '<img class="[ logo-footer ]" src="'. THEMEPATH .'img/logo-circular.png">' . '</span>' . "\n";
			}
