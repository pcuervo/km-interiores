...
<?php
	if ( $order->billing_email ) {
		echo '<tr><th>' . esc_html__( 'Email:', 'woocommerce' ) . '</th><td data-title="' . esc_html__( 'Email', 'woocommerce' ) . '">' . $order->billing_email . '</td></tr>';
	}

	if ( $order->billing_phone ) {
		echo '<tr><th>' . esc_html__( 'Telephone:', 'woocommerce' ) . '</th><td data-title="' . esc_html__( 'Telephone', 'woocommerce' ) . '">' . $order->billing_phone . '</td></tr>';
	}
